...
public class ProgramDescription extends JFrame {
	...
	public ProgramDescription() {
		...
		VirtualRunLogo.setIcon(new ImageIcon("C:\\Users\\Farah Nabilah\\Desktop\\Hope Soup Kitchen\\HopeVirtualRunn.PNG"));
		...
		BreakfastLogo.setIcon(new ImageIcon("C:\\Users\\Farah Nabilah\\Desktop\\Hope Soup Kitchen\\Breakfast.PNG"));
		BreakfastLogo.setBounds(81, 431, 105, 129);
		panel.add(BreakfastLogo);
		
		JLabel LunchLogo = new JLabel("");
		LunchLogo.setIcon(new ImageIcon("C:\\Users\\Farah Nabilah\\Desktop\\Hope Soup Kitchen\\Lunch.PNG"));
		LunchLogo.setBounds(259, 416, 105, 129);
		panel.add(LunchLogo);
		
		JLabel DinnerLogo = new JLabel("");
		DinnerLogo.setIcon(new ImageIcon("C:\\Users\\Farah Nabilah\\Desktop\\Hope Soup Kitchen\\Dinner.PNG"));
